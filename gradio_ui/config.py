...
from config.constants import (
    ...
    GRADIO_ROUTE_CLAUSE_UPLOAD,
    GRADIO_ROUTE_CLAUSE_CONTEXT,
    GRADIO_ROUTE_CLAUSE_CLEAR,
    GRADIO_ROUTE_CHAT_STREAM,
)
...
API_CLAUSE_UPLOAD = lambda: get_full_url(GRADIO_ROUTE_CLAUSE_UPLOAD)
API_CLAUSE_CONTEXT = lambda: get_full_url(GRADIO_ROUTE_CLAUSE_CONTEXT)
API_CLAUSE_CLEAR = lambda: get_full_url(GRADIO_ROUTE_CLAUSE_CLEAR)
API_CHAT_STREAM = lambda: get_full_url(GRADIO_ROUTE_CHAT_STREAM)
